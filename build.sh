...
echo "sudo docker run --name d-apache-letsencrypt-proxy-reverse -tdi -p 80:80/tcp -p 2222:22/tcp -p 443:443/tcp davask/d-apache-letsencrypt-proxy-reverse:${branch}";
